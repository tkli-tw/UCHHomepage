...
var BrickMotion = {
	...
	hightlight : function(event){
		...
		brick.style.backgroundColor = BrickMotion.HIGHT_LIGHT_COLOR;
	...
	normal : function(event){
		...
		var brick= event.target;
		brick.style.backgroundColor = BrickMotion.NORMAL_COLOR;
	...
	select : function(event){
		...
		if (BrickMotion.selectedBrick ) {            
			...
			brick.style.backgroundColor = BrickMotion.SELECTED_COLOR;
	...
	release : function(event){
		BrickMotion.selectedBrick.style.backgroundColor = BrickMotion.NORMAL_COLOR;
